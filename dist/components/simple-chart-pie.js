...
class SimpleChartPie extends Component {
  ...
  paint = modifier((element, [data, isIcon, isClickable, hover, leave, onClick, containerHeight, containerWidth, textIsNotOutlined]) => {
    ...
    const chart = svg.append('g').attr('class', 'chart') //move the pie into the center of the chart
  ...
  static {
    setComponentTemplate(precompileTemplate("<svg xmlns=\"http://www.w3.org/2000/svg\" class=\"simple-chart-pie{{if this.isLoading \" loading\" \" loaded\"}}\" height={{@containerHeight}} width={{@containerWidth}} {{this.paint this.dataOrArray @isIcon @isClickable @hover @leave @onClick @containerHeight @containerWidth @textIsNotOutlined}} ...attributes></svg>", {
      strictMode: true
    }), this);
  }
}
